...
<div id="divcom">
    ...
    foreach ($wall as $comment)
    {
        ...
        $tmp = "<li><a target=\"_blank\" href=\"".$comment->comment_author_url."\">".$avatar."<span>".$comment->comment_author."</span>
                        <strong>+".$comment->cnt."</strong></br>".$comment->comment_author_url."</a></li>";
        $output .= $tmp;
      }
